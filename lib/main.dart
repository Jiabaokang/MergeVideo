...
void main() async {
  ...
  //final beeStream = commandBuilder.addAsset("assets/iShot_2023-02-14.mp4");
  final beeStream = commandBuilder.addAsset("C:/Users/jiaba/Videos/Captures/bee.mp4");
  //final beeStream = commandBuilder.addAsset("C:/Users/jiaba/Videos/Captures/DroneFootageofHighRisesinaCity.mp4");
  //String beePath = path.join("C:/Users/jiaba/Videos/Captures", 'DroneFootageofHighRisesinaCity.mp4');
  // final beeStream = commandBuilder.addAsset(beePath);
